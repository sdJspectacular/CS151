 ...
 *
 * Algorithm:
 *   1. Ask the user to input an integer (or -1 to exit)
 *   2. Demonstrate stringification using to_string
 *   3. Convert the string back to an integer
 *   4. Convert to binary by using a c-string
 *   5. Convert the binary number back into a decimal number
 *   6. Convert into hex
 *   7. Convert back into decimal, and demonstrate the original value
 */
#include <iostream>
#include <algorithm>
#include <cctype>
...
int main()
{
    while (true)
    {
        ...
        int original;
        cout << "Please enter an integer, or -1 to exit: ";
        cin >> original;
        ...
        stringstream inpstr(orig_to_string);
        int original_copy;
        ...
        *(binary + 32) = '\0';
        ...
        stringstream iostr;
        iostr << hex << original;
        cout << "The original number in hex is: " << iostr.str() << '\n';

        // 7. Back to decimal and print
        iostr >> hex >> original_copy;
        cout << "The number back to decimal is: " << original_copy << "\n";
